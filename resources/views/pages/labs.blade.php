...
@section('content')
  ...
  <x-section id="function" tone="paper" eyebrow="01 · Institutional function">
    <div class="labs-intro-grid">
      ...
      <figure class="editorial-image editorial-image--portrait">
        <img src="{{ asset('img/founder/founder-03.jpeg') }}" alt="Dr. Elizabeth Consoli receiving recognition from dermatology peers" loading="lazy" width="900" height="1200">
  ...
  <x-section id="research" tone="paper" eyebrow="04 · Horizon">
    <div class="labs-horizon-grid">
      <figure class="editorial-image editorial-image--portrait">
        <img src="{{ asset('img/founder/founder-05.jpeg') }}" alt="Dr. Elizabeth Consoli discussing skin-care formulation" loading="lazy" width="900" height="1200">
